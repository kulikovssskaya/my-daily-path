...
Для выявления аномалий полезны гистограмма и box plot. «Ящик» содержит значения между 0.25-м и 0.75-м квартилями (IQR), «усы» — от минимума до максимума, оранжевая линия — медиана.

```python
plt.boxplot(df.odometer)

# Форматирование значений по оси
...
Ориентиры силы связи: **слабая** — от 0.5, **сильная** — от 0.7, **высокая** — от 0.9.
