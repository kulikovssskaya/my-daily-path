...
Write-Host "  - Starts dev server 20s after login (NO browser window)"
Write-Host "  - Open the app yourself: bookmark http://localhost:3000/schedule"
Write-Host "  - To also open the app on login: edit start-dev.ps1 or run: npm run dev:open"
Write-Host "  - To stop autostart entirely: npm run autostart:remove"
